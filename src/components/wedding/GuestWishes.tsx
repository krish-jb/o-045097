         ...
         <div className="container mx-auto px-1">
            ...
            <div className="flex md:flex-row flex-col gap-6 md:gap-0">
               ...
               <div className="flex md:flex-col gap-1">
                  <FadeIn key={"add_button"} delay={100 * 4} className="w-full">
                        ...
                        <DialogTrigger asChild>
                           ...
                           >
                              <CardContent className="flex flex-col justify-center items-center py-3 px-6">
                                 ...
                                 <p className="text-[10px]">New wish</p>
                              </CardContent>
                           </Card>
                        </DialogTrigger>
                        <DialogContent className="sm:max-w-[425px]">
                           <DialogHeader>
                              <DialogTitle>Leave a message for the couple</DialogTitle>
                           </DialogHeader>
                           ...
                           <div className="flex justify-end gap-2">
                              ...
                              <Button onClick={handleAdd} className="rounded-sm" disabled={isLoading}>
                                 Add
                              </Button>
                           </div>
                        </DialogContent>
                  ...
                  <FadeIn key={"view_button"} delay={100 * 5} className="w-full">
                     <Card
                        className="flex items-center justify-center h-full hover:bg-gray-300 active:bg-gray-300 cursor-pointer duration-200"
