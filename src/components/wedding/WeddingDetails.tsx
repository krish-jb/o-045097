...
const WeddingDetails: React.FC = () => {
   ...
   const updateEventDetails = async (event: string, field: string, value: string) => {
   ...
   const updateEventAddress = async (event: string, text: string, link: string) => {
      const success: boolean = await updateWeddingData({
         weddingDetails: {
            ...weddingData.weddingDetails,
            [event]: {
         ...
         <div className="container mx-auto px-4 md:px-6">
            <FadeIn>
               <div className="text-center mb-16">
                  <h2 className="text-3xl md:text-5xl font-serif font-medium tracking-tight mb-6">Wedding Details</h2>
                     ...
                     <CardHeader>
                        <CardTitle className="text-2xl font-serif">
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("event1", "title", value)}
                     ...
                     <CardContent className="space-y-4">
                        ...
                        <div>
                           ...
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("event1", "venue", value)}
                              label="Edit Ceremony Venue"
                              className="block font-medium"
                           />
                           <div className="w-full p-0 flex items-center justify-between">
                              <EditableLink
                                 text={weddingData.weddingDetails.event1.address}
                     ...
                     <CardHeader>
                        <CardTitle className="text-2xl font-serif">
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("event2", "", value)}
                     ...
                     <CardContent className="space-y-4">
                        <div>
                           ...
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("event2", "date", value)}
                              label="Edit Reception Date"
                              className="block font-medium"
                           />
                           <EditableText
                              value={weddingData.weddingDetails.event2.time}
                              onSave={(value) => updateEventDetails("event2", "time", value)}
                        ...
                        <div>
                           ...
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("event2", "venue", value)}
                              label="Edit Reception Venue"
                              className="block font-medium"
                           />
                           <div className="w-full p-0 flex items-center justify-between">
                              <EditableLink
                                 text={weddingData.weddingDetails.event2.address}
                  ...
                  <Card>
                     <CardHeader>
                        <CardTitle className="text-xl font-serif">
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("toKnow1", "title", value)}
                     ...
                     <CardContent>
                        <EditableText
                           ...
                           onSave={(value) => updateEventDetails("toKnow1", "description", value)}
                           label={`Edit ${weddingData.weddingDetails.toKnow1.title} description`}
                           multiline
                  ...
                  <Card>
                     <CardHeader>
                        <CardTitle className="text-xl font-serif">
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("toKnow2", "title", value)}
                     ...
                     <CardContent>
                        <EditableText
                           ...
                           onSave={(value) => updateEventDetails("toKnow2", "description", value)}
                           label={`Edit ${weddingData.weddingDetails.toKnow2.title} description`}
                           multiline
                           className="text-muted-foreground text-left"
                        />
                     </CardContent>
                  ...
                  <Card>
                     <CardHeader>
                        <CardTitle className="text-xl font-serif">
                           <EditableText
                              ...
                              onSave={(value) => updateEventDetails("toKnow3", "title", value)}
                     ...
                     <CardContent>
                        <EditableText
                           ...
                           onSave={(value) => updateEventDetails("toKnow3", "description", value)}
